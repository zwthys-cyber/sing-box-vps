...
local ARGO_AUTH=${12}
  ...
  remote_command="export reym=$REALITY UUID=$SUUID vless_port=$TCP1_PORT vmess_port=$TCP2_PORT hy2_port=$UDP_PORT reset=$RES resport=$REP ARGO_DOMAIN=${ARGO_DOMAIN} ARGO_AUTH=${ARGO_AUTH} && bash <(curl -Ls https://raw.githubusercontent.com/zwthys-cyber/sing-box-vps/main/serv00keep.sh)"
...
echo "*****************************************************"
echo "*****************************************************"
echo "项目地址  ：github.com/zwthys-cyber"
echo "仓库文档 ：github.com/zwthys-cyber/sing-box-vps"
echo "项目主页 ：github.com/zwthys-cyber/sing-box-vps"
